...
1. Create your templates under {project_name}/templates/
2. Create your source tables under {project_name}/tables/ (you may skip this if you want to refresh from gsheets)
